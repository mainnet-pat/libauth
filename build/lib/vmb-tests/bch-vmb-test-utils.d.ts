import type { AuthenticationTemplate, AuthenticationTemplateScenario } from '../lib';
/**
...
declare type TestSetType = 'invalid' | 'nonstandard' | 'standard';
declare type TestSetOverrideType = TestSetType | 'ignore';
declare type VmVersionBCH = typeof vmVersionsBCH[number];
declare type VmMode = typeof vmModes[number];
declare type TestSetOverrideLabelBCH = 'default' | `${TestSetOverrideType}` | `${VmMode}_${TestSetOverrideType}` | `${VmMode}` | `${VmVersionBCH}_${TestSetOverrideType}` | `${VmVersionBCH}_${VmMode}_${TestSetOverrideType}` | `${VmVersionBCH}`;
export declare type TestSetIdBCH = `${VmVersionBCH}_${TestSetType}`;
export declare type VmbTestMasterBCH = [
    shortId: string,
...
export declare type VmbTestDefinition = [
    /**
...
export declare type VmbTestDefinitionGroup = [
