import type { AuthenticationInstruction, AuthenticationProgramStateMinimum, AuthenticationProgramStateStack } from '../lib';
...
declare type StringSegmentType = 'BigIntLiteral' | 'BinaryLiteral' | 'Comment' | 'HexLiteral' | 'Identifier' | 'UTF8Literal';
declare type RecursiveSegmentType = 'Evaluation' | 'Push';
...
export declare type ResolvedSegment = ResolvedSegmentBytecode | ResolvedSegmentComment | ResolvedSegmentError | ResolvedSegmentEvaluation<ResolvedScript> | ResolvedSegmentPush<ResolvedScript>;
...
export declare type ScriptReductionTraceChildNode<ProgramState> = ScriptReductionTraceErrorNode | ScriptReductionTraceEvaluationNode<ProgramState> | ScriptReductionTraceNode | ScriptReductionTracePushNode<ProgramState>;
/**
...
export declare type CompilationResultError<ProgramState> = CompilationResultParseError | CompilationResultReduceError<ProgramState> | CompilationResultResolveError;
...
export declare type CompilationResult<ProgramState = AuthenticationProgramStateMinimum & AuthenticationProgramStateStack> = CompilationResultError<ProgramState> | CompilationResultSuccess<ProgramState>;
export {};
