...
import { decodeTransactionCommon, encodeTokenPrefix, encodeTransactionCommon, hashTransaction, hashTransactionP2pOrder, hashTransactionUiOrder, hexToBin, readTokenPrefix, sha256, } from '../lib.js';
...
test('decodeTransaction: invalid', (t) => {
    t.deepEqual(decodeTransactionCommon(hexToBin('00')), 'Error reading transaction. Error reading Uint32LE: requires 4 bytes. Provided length: 1');
});
