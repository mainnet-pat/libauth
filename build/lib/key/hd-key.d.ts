 ...
 */
export declare type HdKeyNetwork = 'mainnet' | 'testnet';
/**
 ...
 */
export declare type HdPrivateNode = HdPrivateNodeInvalid | HdPrivateNodeValid;
/**
...
declare type PrivateResults<NodeType> = NodeType extends HdPrivateNodeKnownParent ? HdPrivateNodeKnownParent : HdNodeDerivationError.childIndexExceedsMaximum | HdNodeDerivationError.nextChildIndexRequiresHardenedAlgorithm | HdPrivateNodeValid;
declare type PublicResults<NodeType> = NodeType extends HdPublicNodeKnownParent ? HdPublicNodeKnownParent : HdNodeDerivationError.hardenedDerivationRequiresPrivateNode | HdNodeDerivationError.nextChildIndexRequiresHardenedAlgorithm | HdPublicNode;
/**
 ...
 */
declare type ReductionResults<NodeType> = NodeType extends HdPrivateNodeValid ? PrivateResults<NodeType> : PublicResults<NodeType>;
/**
