...
import { authenticationTemplateP2pkh, authenticationTemplateP2pkhNonHd, authenticationTemplateToCompilerConfiguration, createCompilerCommon, hexToBin, stringify, stringifyTestVector, } from '../lib.js';
...
test('authenticationTemplateToCompilerConfiguration: authenticationTemplateP2pkh', (t) => {
    const configuration = authenticationTemplateToCompilerConfiguration(authenticationTemplateP2pkh);
    t.deepEqual(configuration, {
        entityOwnership: {
            key: 'owner',
        },
