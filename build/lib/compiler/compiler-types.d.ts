import type { AuthenticationProgramCommon, AuthenticationTemplateScenario, AuthenticationTemplateVariable, AuthenticationVirtualMachine, CompilationContextBCH, CompilationResult, CompilationResultError, Ripemd160, Secp256k1, Sha256, Sha512 } from '../lib';
 ...
 */
export declare type CompilerOperationSuccessSignatureType = CompilerOperationSuccessDataSignature | CompilerOperationSuccessSignature;
/**
...
export declare type CompilerOperationResult<CanBeSkipped extends boolean = false> = CanBeSkipped extends true ? CompilerOperationError | CompilerOperationSkip | CompilerOperationSuccess : CompilerOperationError | CompilerOperationSuccess;
/**
 ...
 * multiple operations.
 */
export declare type AnyCompilerConfiguration<CompilationContext> = CompilerConfiguration<CompilationContext, string | false, string | false, string | false, string | false, string | false, string | false>;
/**
 * Any compiler configuration where the type of the `operations` value is
 * irrelevant.
 */
export declare type AnyCompilerConfigurationIgnoreOperations<CompilationContext = CompilationContextBCH> = Omit<AnyCompilerConfiguration<CompilationContext>, 'operations'>;
export declare type BytecodeGenerationResult<ProgramState> = CompilationResultError<ProgramState> | {
    bytecode: Uint8Array;
    success: true;
};
/**
