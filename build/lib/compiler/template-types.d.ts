 ...
 */
export declare type AuthenticationVirtualMachineIdentifier = 'BCH_2020_05' | 'BCH_2021_05' | 'BCH_2022_05' | 'BCH_2023_05' | 'BCH_SPEC' | 'BSV_2020_02' | 'BSV_SPEC' | 'BTC_2017_08' | 'BTC_SPEC' | 'XEC_2020_05' | 'XEC_SPEC';
/**
 ...
 */
export declare type AuthenticationTemplateScenarioBytecode = string | {
    /**
 ...
 * transaction.
 */
export declare type AuthenticationTemplateScenarioTransactionOutput = AuthenticationTemplateScenarioOutput<false>;
/**
 * A source output used by an authentication template scenario.
 */
export declare type AuthenticationTemplateScenarioSourceOutput = AuthenticationTemplateScenarioOutput<true>;
/**
...
export declare type AuthenticationTemplateVariable = AuthenticationTemplateAddressData | AuthenticationTemplateHdKey | AuthenticationTemplateKey | AuthenticationTemplateWalletData;
