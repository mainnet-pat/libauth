 ...
 * and `description`.
 */
export declare type ScenarioDefinition = Pick<AuthenticationTemplateScenario, 'data' | 'sourceOutputs' | 'transaction'>;
 ...
 */
export declare type ExtendedScenarioDefinition = Required<Pick<ScenarioDefinition, 'data'>> & Required<Pick<ScenarioDefinition, 'sourceOutputs'>> & RequiredTwoLevels<Pick<ScenarioDefinition, 'transaction'>>;
/**
