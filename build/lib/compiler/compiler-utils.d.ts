import type { AnyCompilerConfiguration, AuthenticationProgramCommon, AuthenticationProgramStateCommon, AuthenticationProgramStateControlStack, AuthenticationProgramStateMinimum, AuthenticationProgramStateStack, AuthenticationTemplate, BytecodeGenerationResult, CompilationContextBCH, CompilationData, CompilationResult, Compiler, CompilerConfiguration } from '../lib';
/**
...
export declare const assembleBytecode: (opcodes: Readonly<{
    ...
    bytecode: Uint8Array;
    success: true;
} | import("../lib").CompilationResultReduceError<AuthenticationProgramStateCommon> | import("../lib").CompilationResultSuccess<AuthenticationProgramStateCommon>;
/**
